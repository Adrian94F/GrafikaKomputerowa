...
void RenderScene(void)
{
	...
	{
		theta += delta_x*pix2angle_x*pi / 180;																// modyfikacja k¹ta obrotu o kat proporcjonalny
		phi += delta_y*pix2angle_y*pi / 180;																// do ró¿nicy po³o¿eñ kursora myszy
		if (phi < -pi / 2)
		{
			phi = -pi / 2;
		}
	...
	// glRotatef(phi, 1.0, 0.0, 0.0);																		//obrót obiektu o nowy k¹t
	// a jest:
